        ...
        <IonRow>
            ...
            >
              <IonCardHeader>
                <IonCardTitle className="text-left">
                  ...
                  Un modello di tecno-regolazione.
                </IonCardTitle>
              </IonCardHeader>
              <IonCardContent className="description blue">
                See more...
          ...
          <IonCol>
            ...
            >
              <IonCardHeader>
                <IonCardTitle className="text-left">
                  Lettieri N., Digital Labour platforms, algorithmic governance
                  and techno-regulation: towards the computational evolution of
                  law and labor studies. Talk presented at the "Reshaping Work
                  2019" International Conference - Amsterdam - 24 October 2019
                </IonCardTitle>
              </IonCardHeader>
              <IonCardContent className="description blue">
                See more...
