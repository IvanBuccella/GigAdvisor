...
const PlatformsMap: React.FC = () => {
      ...
      ret = (
        <>
          ...
          <IonCol
            ...
            sizeXs="12"
          >
            <IonCard href={"/platform-map/" + platform["slug"]}>
              <IonCardHeader>
                <IonCardSubtitle>
                  <IonImg
  ...
  return (
    <>
      ...
      <IonSlide>
        <IonContent className="page-container platforms platforms-map">
          <h1 className="form-title mt1 mb1">
            Choose a Platform to see the Map
          </h1>
